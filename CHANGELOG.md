...
- `block_sample_counts` public property to `RawBinFile` and `Reader`
...
- Allow float-formatted numeric values in `PNSSet` sensor fields
- Handle sub-microsecond timestamps in `_parse_time_str`
- Correct `Optional[str]` type annotation on calibration setter
...
[Unreleased]: https://github.com/bel-public/mffpy/compare/v0.11.0...HEAD
[0.11.0]: https://github.com/bel-public/mffpy/compare/v0.10.0...v0.11.0
